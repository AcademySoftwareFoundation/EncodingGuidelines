...
listimages = []
listimages.append({'label': 'raw png PIL', 'image': os.path.basename(source_image)})
...
listimages.append({'label': 'srgb png PIL', 'image': "greyscale-srgb.png"})
listimages.append({'label': 'srgb png photoshop', 'image': "../../sourceimages/greyscale-source-srgb-ps.png"})
listimages.append({'label': 'srgb png nuke', 'image': "../../sourceimages/greyscale-source-srgb.png"})
...
listimages.append({'label': 'gamma2.2 png photoshop', 'image': "../../sourceimages/greyscale-source-gamma22-ps.png"})
listimages.append({'label': 'gamma2.2 png nuke', 'image': "../../sourceimages/greyscale-source-gamma22.png"})
listimages.append({'label': 'gamma2.8 png photoshop', 'image': "../../sourceimages/greyscale-source-gamma28-ps.png"})
listimages.append({'label': 'lin png photoshop', 'image': "../../sourceimages/greyscale-source-lin-ps.png"})
listimages.append({'label': 'lin png nuke', 'image': "../../sourceimages/greyscale-source-lin.png"})
...
trc_types = [{'label': "-color_trc 1 = rec709", 'fileext': "rec709", 'trcnum': 1, 'gamma': 1.95},
			{'label': "-color_trc 13 = sRGB photoshop", 'fileext': "srgb", 'trcnum': 13, 'gamma': 2.2},
			{'label': "-color_trc 13 = sRGB nuke", 'fileext': "srgb-ps", 'trcnum': 13, 'gamma': 2.2},
			{'label': "-color_trc 4 = gamma 2.2 photoshop", 'fileext': "gamma22-ps", 'trcnum': 4, 'gamma': 2.2},
			{'label': "-color_trc 4 = gamma 2.2 nuke", 'fileext': "gamma22", 'trcnum': 4, 'gamma': 2.2},
			{'label': "-color_trc 5 = gamma 2.8", 'fileext': "gamma28", 'trcnum': 5, 'gamma': 2.8},
			{'label': "-color_trc 8 = linear photoshop", 'fileext': "lin-ps", 'trcnum': 8, 'gamma': 1},
			{'label': "-color_trc 8 = linear nuke", 'fileext': "lin", 'trcnum': 8, 'gamma': 1},
			]
