...
echo oiiotool -v -framepadding 6 --parallel-frames --frames 44200-44399 -i chimera_coaster_srgb/chimera_coaster_srgb.#.png ${ops} -o chimera_coaster_srgb_${ext}_${bitdepth}/chimera_coaster_srgb.#.$ext
...
oiiotool -v --framepadding 6 --parallel-frames --frames 66600-66799 -i chimera_wind_srgb/chimera_wind_srgb.#.png ${ops} -o  chimera_wind_srgb_${ext}_${bitdepth}/chimera_wind_srgb.#.$ext
